...
for (i in 1:nrow(df_normalizations) ){
  ...
  # out = c(out, knitr::knit_child('multiple-PCA-2021-03-12 section.Rmd'))
  
  # cat(knitr::asis_output(knitr::knit_child("multiple-PCA-2021-03-12 section.Rmd", quiet=TRUE)))
  result = knitr::knit_expand(file = "multiple-PCA-2021-03-12 section.Rmd")
  out[[i]] = result
