...
vecVariables = c("patient.age", "WOMEN", "right.eye", "axial.eye.length",
                 ...
                 "rebubbling", "X2nd.rebubbling", "centr_detachment_graft",
...
df.univ %>%
  mutate(
    mean_sd_dmek = paste0(formatC(mean_dmek, digits = 3, format = "f"), "±",
                          formatC(sd_dmek, digits = 3, format = "f")),
    N_pct_dmek = paste0(N_dmek, " (",
                        formatC(pct_dmek, digits = 1, format = "f"), ")"),
    dmek = if_else(is01variable, N_pct_dmek, mean_sd_dmek),
    
    mean_sd_dsaek = paste0(formatC(mean_dsaek, digits = 3, format = "f"), "±",
                           formatC(sd_dsaek, digits = 3, format = "f")),
    N_pct_dsaek = paste0(N_dsaek, " (",
                         formatC(pct_dsaek, digits = 1, format = "f"), ")"),
    dsaek = if_else(is01variable, N_pct_dsaek, mean_sd_dsaek),
    
    mean_sd_ut_dsaek = paste0(formatC(mean_ut_dsaek, digits = 3, format = "f"), "±",
                              formatC(sd_ut_dsaek, digits = 3, format = "f")),
